        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QGroup = table.Column<int>(type: "int", nullable: false),
                    CorrectiveAction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponsibleTeam = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_AspNetUsers_SubmittedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueAnswers_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssueAnswers_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueEmbeddings", x => x.IssueId);
                    table.ForeignKey(
                        name: "FK_IssueEmbeddings_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssueComments_IssueAnswers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "IssueAnswers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueAnswers_AuthorId",
                table: "IssueAnswers",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueAnswers_IssueId",
                table: "IssueAnswers",
                column: "IssueId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueComments_AnswerId",
                table: "IssueComments",
                column: "AnswerId");
